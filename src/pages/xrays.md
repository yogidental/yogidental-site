---
title: "Xrays"
description: "Yogi Dental's digital X-rays provide clear, detailed images with minimal radiation exposure — detecting issues early and ensuring precise, safe dental care."
format: md
slug: /xrays
...
<span className="yd-page-banner__title">Dental X-Rays</span>
...
Our digital X-rays provide clear, detailed images with minimal radiation exposure. They help detect issues early, guide treatment, and ensure precision in dental care. Enjoy faster results, safer imaging, and more accurate diagnoses with our modern technology.
...
1.Abscesses or cysts 2.Bone loss 3.Cancerous and non-cancerous tumors 4.Decay between the teeth 5.Developmental abnormalities 6.Poor tooth and root positions 7.Problems inside a tooth or below the gum line 8.Impacted teeth
...
![Dentist reviewing a dental X-ray](/img/site/pexels-cottonbro-6529219.jpg)
...
<span className="yd-hours__time"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 18a8 8 0 110-16 8 8 0 010 16zm.5-13H11v6l5.2 3.1.8-1.3-4.5-2.7V7z"/></svg> Open, 09.30 AM - 05.30 PM</span>
</div>

<div className="yd-hours">
<span>Friday - Saturday</span>
<span className="yd-hours__time yd-hours__time--off"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="16" rx="2" fill="none" stroke="currentColor" strokeWidth="1.6"/><path d="M3 9.5h18" stroke="currentColor" strokeWidth="1.6"/><path d="M8 3v4M16 3v4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/><path d="M9.3 13.5l5.4 5.4M14.7 13.5l-5.4 5.4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg> Closed</span>
</div>
...
<div className="yd-form">
  <div className="yd-field">
    <label htmlFor="f-xrays-name">Name</label>
    <input id="f-xrays-name" type="text" placeholder="Enter your name" />
  </div>
  <div className="yd-field">
    <label htmlFor="f-xrays-email">Email <span className="yd-req">*</span></label>
    <input id="f-xrays-email" type="email" placeholder="Enter your email" />
  </div>
  <div className="yd-field">
    <label htmlFor="f-xrays-phone">Contact Number <span className="yd-req">*</span></label>
    <input id="f-xrays-phone" type="tel" placeholder="Enter your contact number" />
  </div>
  <div className="yd-field">
    <label htmlFor="f-xrays-service">Service</label>
    <select id="f-xrays-service" defaultValue="">
  ...
  <div className="yd-field">
    <label htmlFor="f-xrays-type">Patient Type <span className="yd-req">*</span></label>
    <select id="f-xrays-type" defaultValue="">
