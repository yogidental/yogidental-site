...
description: "Keep your smile healthy with professional teeth cleaning at Yogi Dental. Remove plaque, prevent gum disease, and enjoy fresher breath with regular cleanings and check-ups."
format: md
slug: /teeth-cleaning
...
<span className="yd-page-banner__title">Teeth Cleaning</span>
...
![Professional teeth cleaning](/img/site/pexels-karolina-grabowska-6627315.jpg)
...
<div className="yd-form">
  <div className="yd-field">
    <label htmlFor="f-teeth-cleaning-name">Name</label>
    <input id="f-teeth-cleaning-name" type="text" placeholder="Enter your name" />
  </div>
  <div className="yd-field">
    <label htmlFor="f-teeth-cleaning-email">Email <span className="yd-req">*</span></label>
    <input id="f-teeth-cleaning-email" type="email" placeholder="Enter your email" />
  </div>
  <div className="yd-field">
    <label htmlFor="f-teeth-cleaning-phone">Contact Number <span className="yd-req">*</span></label>
    <input id="f-teeth-cleaning-phone" type="tel" placeholder="Enter your contact number" />
  </div>
  <div className="yd-field">
    <label htmlFor="f-teeth-cleaning-service">Service</label>
    <select id="f-teeth-cleaning-service" defaultValue="">
  ...
  <div className="yd-field">
    <label htmlFor="f-teeth-cleaning-type">Patient Type <span className="yd-req">*</span></label>
    <select id="f-teeth-cleaning-type" defaultValue="">
